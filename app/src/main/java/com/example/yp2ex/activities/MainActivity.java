...
public class MainActivity extends AppCompatActivity {
    ...
    public void updProgressBars() {
        binding.progressBarHappy.setText(tamagochi.getHappy() + "");
        binding.progressBarBore.setText(tamagochi.getBore() + "");
        binding.progressBarTired.setText(tamagochi.getTired() + "");
        binding.progressBarHunger.setText(tamagochi.getHunger() + "");
    }
